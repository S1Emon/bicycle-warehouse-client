            ...
            <div id="carouselExampleDark" className="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active" data-bs-interval="10000">
                        <img src="https://i.ibb.co/Pr7Dw4g/banner4.jpg" className="d-block w-100" alt="..." />
                    ...
                    <div className="carousel-item" data-bs-interval="2000">
                        <img src="https://i.ibb.co/vYgLkWY/cyclist-bycicle-race-1.jpg" className="d-block w-100" alt="..." />
                    ...
                    <div className="carousel-item">
                        <img src="https://i.ibb.co/hWxfTDn/banner.jpg" className="d-block w-100" alt="..." />
                        <div className="carousel-caption d-none d-md-block">
